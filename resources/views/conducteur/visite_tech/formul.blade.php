...
<body>
    <main class="main" id="top">
        <div class="container-fluid px-0">
            ...
            <div class="content">
                <form class="row g-3" method="POST" action="/conducteur/visite/add/{{$matricule}}" >
                 ...
                 <fieldset >
                    ...
                    <div class="col-md-6 mt-4">
                        ...
                        <div class="col-md-6 mt-4">
                            ...
                            <input class="form-control form-control-sm" name="datev"  type="text">
                            @error('datev')
                                <div class="alert alert-danger">
                                    {{ $message }}
                    ...
                    <fieldset class="col-md-6 mt-4">
                        ...
                        <div class="col-md-6 mt-4" >
                            <input type="radio" id="huey" name="resultatv" value="visite accepté" checked>
                            <label for="huey">visite accepté</label>
                        </div>
                        <div class="col-md-6 mt-4">
                            <input type="radio" id="dewey" name="resultatv" value="visite non accepté">
