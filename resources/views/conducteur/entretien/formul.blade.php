...
<body>
    <main class="main" id="top">
        <div class="container-fluid px-0">
            ...
            <div class="content">
                <form class="row g-3" method="POST" action="/conducteur/entretien/add/{{$matricule}}" >
                 ...
                 <fieldset >
                    <legend>Caracteristique Entratien</legend>
                        ...
                        <div class="col-md-6 mt-4">
                            ...
                            <input class="form-control form-control-sm" name="dateE"  type="text">
                            @error('dateE')
                                <div class="alert alert-danger">
                                    {{ $message }}
                        ...
                        <div class="col-md-6 mt-4">
                            ...
                            <input class="form-control form-control-sm" name="kilométrage"  type="text">
                            @error('kilométrage')
                                <div class="alert alert-danger">
                                    {{ $message }}
