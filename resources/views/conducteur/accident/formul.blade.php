    ...
    <main class="main" id="top">
        <div class="container-fluid px-0">
            ...
            <div class="content">
                ...
                <form name="form" class="row g-3" method="POST" action="/conducteur/accident/add{{$matricule}}" enctype="multipart/form-data">
                  ...
                  <fieldset >
                        ...
                        <div class="col-md-6 mt-4" >
                            ...
                            <input class="form-control" name="date_A" type="text">
                            @error('date_A')
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-6 mt-4" >
                            ...
                            <input class="form-control" name="assurance" type="text">
                            @error('assurance')
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
