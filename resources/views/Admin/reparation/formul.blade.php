...
<body>
    <main class="main" id="top">
        <div class="container-fluid px-0">
            ...
            @include('include.admin.nav',['searchRoute'=>route('reparation.search')]);
            ...
            <div class="content">
                <form class="row g-3" method="POST" action="/admin/reparation/add" >
                    

                    @csrf

                 <fieldset >
                    <legend>Caracteristique vidange</legend>

                        <div class="col-md-6 mt-4">
                            <label class="form-label" >Matricule </label>
                            <input class="form-control form-control-sm" name="matricule"  type="text">
                        ...
                        <div class="col-md-6 mt-4">
                            <label class="form-label" >Date de reparation</label>
                            <input class="form-control form-control-sm" name="date_R"  type="text">
                            @error('date_R')
                                <div class="alert alert-danger">
                                    {{ $message }}
                        ...
                        <div class="col-md-6 mt-4">
                            <label class="form-label" >Dégats</label>
                            <input class="form-control form-control-sm" name="degat"  type="text">
                            @error('degat')
                                <div class="alert alert-danger">
                                    {{ $message }}degat
                        ...
                        <div class="col-md-6 mt-4">
                            ...
                            <input class="form-control form-control-sm" name="montant"  type="text">
                            @error('montant')
                                <div class="alert alert-danger">
                                    {{ $message }}
                        ...
                        <fieldset class="col-md-6 mt-4">
                            <legend>Les information de fornisseur </legend>
                            <div class="col-md-6 mt-4">
                                <label class="form-label" >Raison</label>
                                <input class="form-control form-control-sm" name="raison"  type="text">
                                @error('raison')
                                    <div class="alert alert-danger">
                                        {{ $message }}
                            ...
                            <div class="col-md-6 mt-4">
                                ...
                                <input class="form-control form-control-sm" name="adresse"  type="text">
                                @error('adresse')
                                    <div class="alert alert-danger">
                                        {{ $message }}
                            ...
                            <div class="col-md-6 mt-4">
                                <label class="form-label" >Telephonne</label>
                                <input class="form-control form-control-sm" name="telephonne"  type="text">
                                @error('telephonne')
                                    <div class="alert alert-danger">
                                        {{ $message }}
                        ...
                        <div class="col-12 mt-4">
                            <a href="/admin/marque"> <button  href="/admin/voiture" type="button" class="btn btn-light" >Annuler</button></a>
