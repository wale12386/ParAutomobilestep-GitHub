...
<body>
    <main class="main" id="top">
        <div class="container-fluid px-0">
            ...
            @include('include.admin.nav',['searchRoute'=>route('fournisseur.search')]);
            ...
            <div class="content">
                <form class="row g-3" method="POST" action="/admin/fournisseur/add" >
                    

                    @csrf

                 <fieldset >
                    <legend>Caracteristique fournisseur</legend>
                    ...
                    <div class="col-md-6 mt-4">
                        ...
                        <input class="form-control form-control-sm" name="telephone"  type="text">
                        @error('telephone')
                            <div class="alert alert-danger">
                                {{ $message }}
