...
<body>
    <main class="main" id="top">
        <div class="container-fluid px-0">
            ...
            @include('include.admin.nav',['searchRoute'=>route('deplacement.search')])
            ...
            <div class="content">
                <form class="row g-3" method="POST" action="/admin/deplacement/add" >
                    

                    @csrf

                 <fieldset >
                    <legend>Caracteristique deplacement</legend>
                        ...
                        <div class="col-md-6 mt-4">
                            ...
                            <input class="form-control form-control-sm" name="destination"  type="text">
                            @error('destination')
                                <div class="alert alert-danger">
                                    {{ $message }}degat
                        ...
                        <div class="col-md-6 mt-4">
                            <label class="form-label" >Quantite carburant</label>
                            <input class="form-control form-control-sm" name="qte_carburant"  type="text">
                            @error('qte_carburant')
                                <div class="alert alert-danger">
                                    {{ $message }}
                        ...
                        <div class="col-12 mt-4">
                            <a href="/admin/deplacement"> <button  href="/admin/voiture" type="button" class="btn btn-light" >Annuler</button></a>
