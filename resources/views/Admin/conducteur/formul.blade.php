...
<body>
    <main class="main" id="top">
        <div class="container-fluid px-0">
            ...
            <div class="content">
                <form class="row g-3" method="POST" action="/admin/conducteur/add" enctype="multipart/form-data">
                    

                    @csrf

                 <fieldset >
                    <legend>Caracteristique conducteur</legend>

                        <div class="col-md-6 mt-4">
                            <label class="form-label" >CIN</label>
                            <input class="form-control" name="CINC" type="text">
                            @error('CINC')
                        ...
                        <div class="col-md-6 mt-4" >
                            ...
                            <input class="form-control" name="date_naissance" type="text">
                        ...
                        <div class="col-md-6 mt-4" >
                            ...
                            <input class="form-control" name="email" type="mail">
                            @error('email')
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
