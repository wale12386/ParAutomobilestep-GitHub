...
<body onchange="myFunc()">
    <main class="main" id="top">
        <div class="container-fluid px-0">
            ...
            @include('include.admin.nav',['searchRoute'=>route('constat.search')]);
            ...
            <div class="content">
                ...
                <form name="form" class="row g-3" method="POST" action="/admin/constat/add" enctype="multipart/form-data">
