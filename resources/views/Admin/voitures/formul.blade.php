    ...
    <main class="main" id="top">
        <div class="container-fluid px-0">
            ...
            <div class="content">
                ...
                <form action="/admin/voiture/add" method="POST"  enctype="multipart/form-data">
                 ...
                 <fieldset >
                    <legend>Caracteristique voiture</legend>
                        ...
                        <div class="col-md-6 mt-4" >
                            ...
                            <input class="form-control" name="Date_1ere_cerculation" type="text">
                        ...
                        <div class="col-md-6 mt-4" >
                            ...
                            <input class="form-control" name="couleur" type="text" >
                            @error('couleur')
                                <div class="alert alert-danger">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-6 mt-4" >
                            ...
                            <select class="form-control" name="marque">
                                @foreach ($marques as $c )
                                    <option value="{{$c->idmarque}}">{{$c->libellemarque}}</option>
                                @endforeach
                            </select> 
                            @error('marque')
                                <div class="alert alert-danger">
                        ...
                        <fieldset class="col-md-6 mt-4">
                            ...
                            <div class="col-md-6 mt-4" >
                                <input type="radio" id="huey" name="gps" value="GPS instalé" checked>
                                <label for="huey">GPS instalé</label>
                            </div>

                            <div class="col-md-6 mt-4">
                                <input type="radio" id="dewey" name="gps" value="GPS non instalé">
                        ...
                        <div class="col-12 mt-4">
                            <a href="/admin/taxe"> <button  href="/admin/voiture" type="button" class="btn btn-light" >Annuler</button></a>
