...
<body>
    <main class="main" id="top">
        <div class="container-fluid px-0">
            ...
            <div class="content">
                <form class="row g-3" method="POST" action="/admin/modele/add" >
                 ...
                 <fieldset >
                    <legend>Caracteristique modele</legend>
                        ...
                        <div class="col-md-6 mt-4">
                            ...
                            <input class="form-control" name="libellemodele" type="text">
                            @error('libellemodele')
                        ...
                        <div class="col-md-6 mt-4">
                            ...
                            <select class="form-control" name="marque">
                                @foreach ($marques as $c )
                                    <option value="{{$c->libellemarque}}">{{$c->libellemarque}}</option>
                                @endforeach
                            </select>
                            @error('marque')
                                <div class="alert alert-danger">
