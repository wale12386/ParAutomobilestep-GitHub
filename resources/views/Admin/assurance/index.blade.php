    ...
    <main class="main" id="top">
      <div class="container-fluid px-0">
        ...
        <div class="content">
          ...
          <hr>
          <a href="/admin/assurance/add" class="mt-6">
              ...
              @foreach($assurance as $index=>$c)
                <tr>
                  ...
                  <td>
                    ...
                    <a href="" data-bs-toggle="modal" data-bs-target="#modifierassurance{{$c->id_assurance}}">
                            ...
                            <div class="modal-body">
                              ...
                              <fieldset >
                                    ...
                                    <div class="col-md-6 mt-4" >
                                        ...
                                        <input class="form-control" name="dateass" type="text" value="{{$c->dateAssur}}">
                                        @error('dateass')
                                            <div class="alert alert-danger">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <fieldset class="col-md-6 mt-4">
                                        ...
                                        <div class="col-md-6 mt-4" >
                                            <input type="radio" id="huey" name="contrat" value="6 mois" {{ ($c->contratAssur == '6 mois') ? 'checked' : '' }}>
                                            <label for="huey">contrat de 6 mois</label>
                                        </div>
            
                                        <div class="col-md-6 mt-4">
                                            <input type="radio" id="dewey" name="contrat" value=" 1 an" {{ ($c->contratAssur == '1 an') ? 'checked' : '' }}>
                                    ...
                                    <div class="col-12 mt-4">
                                      <div class="modal-footer"><button class="btn btn-primary" type="submit">Modifier</button><button class="btn btn-outline-primary" type="button" data-bs-dismiss="modal">Cancel</button></div>
                                    </div>
                                </fieldset> 
